...
import controllers.ModifyInController;
import controllers.ModifyOutController;
...
public class FrontController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		try {
			...
			}else if(uri.endsWith("modifyin.do")){
				controller = new ModifyInController();
			}else if(uri.endsWith("modifyout.do")){
				controller = new ModifyOutController();
			}else{
				controller = new ListController();
			}
			//컨트롤러

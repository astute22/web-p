 ...
 * Generated at: 2017-09-07 02:30:03 UTC
...
public final class tmpImgUpload_jsp extends org.apache.jasper.runtime.HttpJspBase
	...
	for (int i = 0; i < items.size(); i++) {
		...
		try {
			...
			if (itemName == null || itemName.equals(""))
				continue;
			String fileName = FilenameUtils.getName(itemName);// 경로없이 파일이름만 추출
			System.out.println(fileName);
			File savedFile = new File("C:\\web_eclipse\\web_workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\semi-project-1team\\tmpimg\\" + fileName);
			item.write(savedFile);// 지정 경로에 파일을 저장
		} catch (Exception e) {
